...
DAY_PRODUCT_OPENING_STOCK_COL: int = 3
DAY_PRODUCT_STOCK_IN_COL: int = 4
DAY_PRODUCT_STOCK_OUT_COL: int = 5
DAY_PRODUCT_CLOSING_STOCK_COL: int = 6

# month worksheet columns index
MONTH_PRODUCT_NAME_COL: int = 1
MONTH_PRODUCT_CATEGORY_COL: int = 2
MONTH_PRODUCT_LAST_MONTH_STOCK_COL: int = 3
MONTH_PRODUCT_STOCK_IN_COL_OFFSET: int = 4
MONTH_PRODUCT_STOCK_OUT_COL_OFFSET: int = MONTH_PRODUCT_STOCK_IN_COL_OFFSET
