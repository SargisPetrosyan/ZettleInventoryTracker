...
DAY_PRODUCT_STOCK_IN_COL: int = 6
DAY_PRODUCT_STOCK_OUT_COL: int = 7
DAY_PRODUCT_AND_VARIANT_ID_COL: int = 8
...
MONTH_PRODUCT_STOCK_IN_NAME_COL_OFFSET: int = 6
MONTH_PRODUCT_STOCK_OUT_NAME_ROW_OFFSET: int = 1
MONTH_PRODUCT_AND_VARIANT_ID_COL: int = 39
