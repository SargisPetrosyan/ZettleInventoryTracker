...
#month product_sample
month_empty_data_sample_titles:list[str] = [
    'name',
    'category',
    'variant',
    'price',
...
month_empty_data_sample_stock_in: list[str] = [
    'in',
    '0',
    '0',
    '0',
    ...
    '0',
    '', ]
month_empty_data_sample_stock_out: list[str] = [
    '',
    '',
    '',
    '',
